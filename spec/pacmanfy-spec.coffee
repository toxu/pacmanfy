...
describe "Pacmanfy", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('pacmanfy')

  describe "when the pacmanfy:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'pacmanfy:toggle'
        expect(pacmanfyPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'pacmanfy:toggle'
        expect(pacmanfyElement).not.toBeVisible()
